...
{
    /// <inheritdoc />
    public partial class InitialSchema_UsersCategoriesPaymentSources : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    source_type = table.Column<PaymentSourceType>(type: "payment_source_type", nullable: false, defaultValueSql: "'other'::payment_source_type"),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()")
                },
                constraints: table =>
                {
